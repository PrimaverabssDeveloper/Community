            ...
            try
            {
                ...
                foreach (Instance instance in this.Instances)
                {
                    ...
                    using (var manager = this.CreateManager<IBotMessageManager, BotMessage>(this.Instances))
                    {
                        ...
                        {
                            List<User> filteredUserList = this.ProcessAccessListExceptions(instance, instance.Users);
                            foreach (User user in instance.Users)
                            {
                                ...
                                BotMessage createdMessage = this.InitializeNewMessage(instance, user.Code, "Hello World from Bot!");
                                ...
                                this.BotMessages.Add(instance.Id, new List<BotMessage>() { createdMessage });
                            }
                        }
                    }
                }
